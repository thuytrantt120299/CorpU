...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PATCH,"/api/v1/sessionalStaff/**").permitAll()
                .antMatchers("/api/v1/units/**").permitAll()
                .antMatchers(HttpMethod.PATCH,"/api/v1/application/**").permitAll()
                .antMatchers("/api/v1/applications/**").permitAll()
                .antMatchers("/api/v1/sessionalStaffs/**").permitAll()
                .anyRequest()
                .authenticated().and()
                .formLogin()
                .and()
